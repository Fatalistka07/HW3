...
public class Main {
    ...
    private static ApiClient[] requestClients(int n) throws URISyntaxException, IOException {
    ...
    private static TxtGeneratedClient[] generateClients(Random r, int n) throws IOException {
